        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Customer Tables</h3>
            </div>
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                include "koneksi.php";
                $query_mysql = mysql_query("SELECT * FROM tb_customer")or die(mysql_error());
                ...
                <th>
                  <div class="btn-group btn-group-sm">
                    <a class="btn btn-success btn-sm" value="edit" name="edit" href="edit-customer.php?id_pelanggan=<?php echo $data['id_pelanggan']; ?>">
                    <i class="fas fa-pencil-alt"></i>
                    </a>
                    <a class="btn btn-danger btn-sm" href="hapus-customer.php?id_pelanggan=<?php echo $data['id_pelanggan']; ?>">
