        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="publicrate.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Public Rate</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Entry Public Rate</h3>
      </div>
      <!-- /.card-body -->
          <form role="form" class="needs-validation" action="publicrate-aksi.php" method="post" novalidate>
              <div class="card-body">
              <input type="hidden" id="type_rate" name="type_rate" value="Public Rate" required>
              <div class="form-group">
                <label for="servis">Type Of Service</label>
                <select class="form-control custom-select" name="servis">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="kota_asal" id="kota_asal" placeholder="Enter Origin" onkeyup="this.value = this.value.toUpperCase()" required>
                  <div class="invalid-feedback">
                    Please Fill Out This Field
                  </div>
                </div>
